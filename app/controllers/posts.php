...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_add_post'])){
    // $_FILES [img] => Array
    // (
    //     [name] => 1Безымянный.png
    //     [type] => image/png
    //     [tmp_name] => C:\OpenServer\userdata\temp\upload\phpED20.tmp
    //     [error] => 0
    //     [size] => 211195
    // )
        // TODO почему это условие при загрузки картинки пустого элемента не уходит в else
